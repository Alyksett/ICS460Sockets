...
// Can remove these at some point
...
// So these seem to be peers that SS maintains to form connections- they're hardcoded in deep in SS without explanation
const strangePeers = JSON.parse(`
  ...
  ``
// This is just for keeping track of our "real" peers
