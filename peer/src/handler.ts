...
export class Client{
  ...
  constructor(peerId: any, socket: any, clusterId: any, signingKeys: any, sharedKey: any, peers: any[]){
    this.peerId = peerId;
    this.socket = socket;
...
function onMessage(message: any, peerId: any){
...
function onJoin(peer: any, peers: any[]){
...
export async function startClient(){
  ...
  cats.on('message', (message: any) => {
    onMessage(message, peerId);
  });
  
  cats.on('#join', (peer: any) => {
